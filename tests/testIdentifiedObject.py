...
class IdentifiedObjectTests(unittest.TestCase):
    ...
    def test_equality_when_identical_values(self):
        ident_1: IdentifiedObject = IdentifiedObject(2, 2, 2, 2, "Test")
        ident_2: IdentifiedObject = IdentifiedObject(2, 2, 2, 2, "Test")
    ...
    def test_non_equality_when_different_values(self):
        ident_1: IdentifiedObject = IdentifiedObject(2, 2, 2, 2, "Test")
        ident_2: IdentifiedObject = IdentifiedObject(1, 2, 2, 2, "Test")
        ident_3: IdentifiedObject = IdentifiedObject(2, 1, 2, 2, "Test")
        ident_4: IdentifiedObject = IdentifiedObject(2, 2, 1, 2, "Test")
        ident_5: IdentifiedObject = IdentifiedObject(2, 2, 2, 1, "Test")
        ident_6: IdentifiedObject = IdentifiedObject(2, 2, 2, 2, "Different")
        ident_7: IdentifiedObject = IdentifiedObject(1, 1, 1, 1, "Different")
