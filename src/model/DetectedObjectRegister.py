...
class DetectedObjectRegister:
    ...
    def get_horiz_overlapping_for(self, item: BoundingBox):
        def selection_function(other: BoundingBox) -> bool:
            if item is other:
                return False
    ...
    def get_vert_overlapping_for(self, item: BoundingBox):
        def selection_function(other: BoundingBox) -> bool:
            if item is other:
                return False
    ...
    def __get_sublist(self, selection_function) -> list:
        ...
        for i in range(len(self.__list_of_items)):
            item: BoundingBox = self.__list_of_items[i]
